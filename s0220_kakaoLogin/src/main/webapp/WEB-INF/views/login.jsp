        ...
        <div id="content">
            ...
            <form action="naver_index2.jsp">
                <fieldset style="border: 0">
                    ...
                    <br/>
                    <a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=09e2683929f3b08b6fccbfae25f97312&redirect_uri=http://localhost:8181/kakao/oauth">
